 ...
 * Service Route
 */
App.RouteService = Ember.Route.extend({
    ...
    actions: {
         ...
         * @returns {string}
         */
        getServicePath: function (pathComponent) {
            return ENV.rootURL + pathComponent;
        }
    }
...
App.ArtistsRoute = Ember.Route.extend({
    model: function () {
        ...
        Ember.$.getJSON(App.RouteService.getServicePath('/artists'), function (artists) {
    ...
    actions: {
        createArtist: function () {
            ...
            Ember.$.ajax(App.RouteService.getServicePath('/artists'), {
                type: 'POST',
                dataType: 'json',
...
App.ArtistsSongsRoute = Ember.Route.extend({
    model: function (params) {
        ...
        var url = App.RouteService.getServicePath('/artists' + params.slug);
    ...
    actions: {
        createSong: function () {
            ...
            Ember.$.ajax(App.RouteService.getServicePath('/songs'), {
                type: 'POST',
                dataType: 'json',
                context: this,
